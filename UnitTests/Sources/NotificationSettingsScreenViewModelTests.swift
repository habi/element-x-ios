...
class NotificationSettingsScreenViewModelTests: XCTestCase {
    ...
    var viewModel: NotificationSettingsScreenViewModelProtocol!
    
    var context: NotificationSettingsScreenViewModelType.Context {
        viewModel.context
    }
    
    override func setUpWithError() throws {
        viewModel = NotificationSettingsScreenViewModel(promptType: .regular, initialCount: Constants.counterInitialValue)
    }
