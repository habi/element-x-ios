...
struct ServerConfirmationScreen_Previews: PreviewProvider {
    static let loginViewModel = ServerConfirmationScreenViewModel(homeserverAddress: "matrix.org",
                                                                  authenticationType: .login)
    static let registerViewModel = ServerConfirmationScreenViewModel(homeserverAddress: "matrix.org",
