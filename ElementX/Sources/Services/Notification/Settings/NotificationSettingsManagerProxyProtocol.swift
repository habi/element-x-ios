...
enum NotificationSettingsManagerProxyCallback {
    case notificationSettingsDidChange
}

// sourcery: AutoMockable
protocol NotificationSettingsManagerProxyProtocol {
    var callbacks: PassthroughSubject<NotificationSettingsManagerProxyCallback, Never> { get }
